...
export default function Experience() {
  ...
  const load = () =>
    api.get("/experiences/admin").then((r) => setItems(r.data.data));
  useEffect(() => {
    load();
  }, []);
  const save = async (e) => {
    e.preventDefault();
    try {
      if (editing) await api.put(`${"/experiences"}/${editing}`, form);
  ...
  return (
    <div>
      <h1 className="text-3xl font-black mb-6">Experience</h1>
